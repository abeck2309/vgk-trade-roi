...
const highlights = [
  {
    title: "Trade ROI",
    description: "Compare the realized value Vegas received against the value the club gave up in each deal."
  },
  {
    title: "Cap Efficiency",
    description: "Layer contract cost over performance to see which trades returned the most value per dollar committed."
  },
  {
    title: "Methodology",
    description: "Understand how xGAR, GSAx, expected value, and time discounting shape the project's scoring."
  }
];
...
const previewCards = [
  {
    ...
    description: "A quick view of overall trade returns, balancing value received against value sent out.",
    imageSrc: "/trade-roi-dashboard-preview.png",
    imageAlt: "Preview of the Trade ROI dashboard"
  },
  {
    title: "Cap Efficiency Dashboard",
    description: "A focused look at how contract cost and on-ice value interacted across the evaluated trade window.",
    ...
    <Container className="space-y-20 pb-20 pt-12 md:space-y-24 md:pt-16">
      <section className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className="space-y-8">
          <div className="space-y-4">
            <p className="eyebrow">Vegas Golden Knights Trade ROI Analysis</p>
      ...
      <section className="space-y-8">
        <PageIntro
          ...
          description="This section is designed to showcase the main Trade ROI and Cap Efficiency views before users click into the full dashboards page."
        />
