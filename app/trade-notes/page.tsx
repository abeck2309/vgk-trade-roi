              ...
              <div className="bg-panel px-5 py-5">
                <div className="flex items-start gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-start justify-center">
                    <Image src="/vgk-logo.png" alt="Vegas Golden Knights logo" width={54} height={54} className="h-14 w-14 object-contain" />
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-[0.2em] text-gold-bright">Vegas Golden Knights</p>
                    <p className="mt-2 text-base font-semibold text-white">Sent Marc-Andre Fleury</p>
                    <p className="mt-1 text-sm leading-6 text-mist">1 year left, $7 million AAV</p>
                  </div>
                </div>
              </div>
              <div className="flex items-center justify-center bg-panel px-5 py-5">
                <span className="rounded-full border border-gold/30 bg-gold/10 px-4 py-2 text-sm font-semibold text-gold-bright">for</span>
              </div>
              <div className="bg-panel px-5 py-5">
                <div className="flex items-start gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-start justify-center">
                    <Image src="/chi-logo.png" alt="Chicago Blackhawks logo" width={54} height={54} className="h-14 w-14 object-contain" />
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-[0.2em] text-gold-bright">Chicago Blackhawks</p>
                    <p className="mt-2 text-base font-semibold text-white">Sent Mikael Hakkarainen</p>
                    <p className="mt-1 text-sm leading-6 text-mist">Last year of ELC, $825k AAV</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 overflow-hidden rounded-2xl border border-line">
            <div className="grid gap-px bg-line md:grid-cols-[1fr_auto_1fr]">
              <div className="bg-panel px-5 py-5">
                <div className="flex items-start gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-start justify-center">
                    <Image src="/sjs-logo.png" alt="San Jose Sharks logo" width={54} height={54} className="h-14 w-14 object-contain" />
                  </div>
                  <div>
          ...
          <div className="mt-6 overflow-hidden rounded-2xl border border-line">
            <div className="grid gap-px bg-line xl:grid-cols-[1fr_auto_1fr_auto_1fr]">
              ...
              <div className="bg-panel px-5 py-5">
                <div className="flex items-start gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-start justify-center">
                    <Image src="/buf-logo.png" alt="Buffalo Sabres logo" width={54} height={54} className="h-14 w-14 object-contain" />
                  </div>
                  <div>
              ...
              <div className="flex items-center justify-center bg-panel px-5 py-5">
                <span className="rounded-full border border-gold/30 bg-gold/10 px-4 py-2 text-sm font-semibold text-gold-bright">then</span>
              </div>
              <div className="bg-panel px-5 py-5">
                <div className="flex items-start gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-start justify-center">
                    <Image src="/min-logo.png" alt="Minnesota Wild logo" width={54} height={54} className="h-14 w-14 object-contain" />
                  </div>
                  <div>
